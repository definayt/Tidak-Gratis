		...
		<div class="container">
			<div class="flex-w flex-sb-m p-b-52">
				<div class="flex-w flex-l-m filter-tope-group m-tb-10">
					<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" onclick="window.location.href='product.php'">
						Semua
					</button>
				...
				<div class="dis-none panel-filter w-full p-t-10">
					<div class="wrap-filter flex-w bg6 w-full p-lr-40 p-t-27 p-lr-15-sm">
						<a class="filter-link stext-106 trans-04" onclick="produk_sub_kategori(1)">
							Semua
						</a>
						&nbsp; &nbsp; &nbsp; &nbsp;
						<a class="filter-link stext-106 trans-04" onclick="produk_sub_kategori(11)">
							Baju
						</a>
						&nbsp; &nbsp; &nbsp; &nbsp;
						<a class="filter-link stext-106 trans-04" onclick="produk_sub_kategori(12)">
							Celana
						</a>
						&nbsp; &nbsp; &nbsp; &nbsp;
						<a class="filter-link stext-106 trans-04" onclick="produk_sub_kategori(13)">
							Hijab
						</a>
						&nbsp; &nbsp; &nbsp; &nbsp;
						<a class="filter-link stext-106 trans-04" onclick="produk_sub_kategori(14)">
							Jaket
						</a>
						&nbsp; &nbsp; &nbsp; &nbsp;
						<a class="filter-link stext-106 trans-04" onclick="produk_sub_kategori(15)">
							Gamis
						</a>
						<br><br>
					</div>
			...
			<div class="row isotope-grid">
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item">
					...
					$i=0;
						require("connect.php");
	                    $query1 = "SELECT id_produk, gambar1, nama, harga FROM produk WHERE id_kategori=1";
