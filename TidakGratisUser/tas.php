		...
		<div class="container">
			<div class="flex-w flex-sb-m p-b-52">
				...
				<div class="dis-none panel-filter w-full p-t-10">
					<div class="wrap-filter flex-w bg6 w-full p-lr-40 p-t-27 p-lr-15-sm">
						<a class="filter-link stext-106 trans-04" onclick="produk_sub_kategori(2)">
							Semua
						</a>
						&nbsp; &nbsp; &nbsp; &nbsp;
						<a class="filter-link stext-106 trans-04" onclick="produk_sub_kategori(21)">
							Ransel
						</a>
						&nbsp; &nbsp; &nbsp; &nbsp;
						<a class="filter-link stext-106 trans-04" onclick="produk_sub_kategori(22)">
							Hand bag
						</a>
						&nbsp; &nbsp; &nbsp; &nbsp;
						<a class="filter-link stext-106 trans-04" onclick="produk_sub_kategori(23)">
							Sling bag
						</a>
						&nbsp; &nbsp; &nbsp; &nbsp;
						<a class="filter-link stext-106 trans-04" onclick="produk_sub_kategori(24)">
							Tote bag
						</a>
						&nbsp; &nbsp; &nbsp; &nbsp;
						<a class="filter-link stext-106 trans-04" onclick="produk_sub_kategori(25)">
							Clucth bag
						</a>
						<br><br>
					</div>
			...
			<div class="row isotope-grid">
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item">
					...
					$i=0;
						require("connect.php");
	                    $query1 = "SELECT id_produk, gambar1, nama, harga FROM produk WHERE id_kategori=2";
