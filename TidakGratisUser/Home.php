...
<!--MAIN MENU PADA HOME
	Sub kategori produk belum diganti href
	ganti style sub kategori produk
-->
							<li>
...
<!--Data Notity nanti diganti |  |  icon-header-noti js-show-cart tambahkan itu buat style notif, kalau cart pake showcart--> 
			...
			<div class="row">
				...
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					...
					<div class="block1 wrap-pic-w">
						...
						<a href="alaskaki.php" class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
							<div class="block1-txt-child1 flex-col-l">
								<span class="block1-name ltext-102 trans-04 p-b-8">
									Alas Kaki
								</span>
		...
		<div class="container">
			...
			<div class="flex-w flex-sb-m p-b-52">
				<div class="flex-w flex-l-m filter-tope-group m-tb-10">
					...
					<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".tas">
						Tas
					</button>

					<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".alas_kaki">
						Alas Kaki
					</button>
				</div>
				...
				<div class="dis-none panel-filter w-full p-t-10">
					<div class="wrap-filter flex-w bg6 w-full p-lr-40 p-t-27 p-lr-15-sm">
						<div class="filter-col1 p-r-15 p-b-27">	</div>
					</div>
				</div>
			</div>
