		...
		<div class="container">
			<div class="flex-w flex-sb-m p-b-52">
				...
				<div class="dis-none panel-filter w-full p-t-10">
					<div class="wrap-filter flex-w bg6 w-full p-lr-40 p-t-27 p-lr-15-sm">
						<a class="filter-link stext-106 trans-04" onclick="produk_sub_kategori(3)">
							Semua
						</a>
						&nbsp; &nbsp; &nbsp; &nbsp;
						<a class="filter-link stext-106 trans-04" onclick="produk_sub_kategori(31)">
							Sneakers
						</a>
						&nbsp; &nbsp; &nbsp; &nbsp;
						<a class="filter-link stext-106 trans-04" onclick="produk_sub_kategori(32)">
							Flatshoes
						</a>
						&nbsp; &nbsp; &nbsp; &nbsp;
						<a class="filter-link stext-106 trans-04" onclick="produk_sub_kategori(33)">
							High heels
						</a>
						&nbsp; &nbsp; &nbsp; &nbsp;
						<a class="filter-link stext-106 trans-04" onclick="produk_sub_kategori(34)">
							Wedges
						</a>
						&nbsp; &nbsp; &nbsp; &nbsp;
						<a class="filter-link stext-106 trans-04" onclick="produk_sub_kategori(35)">
							Sandal
						</a>
						<br><br>
					</div>
			...
			<div class="row isotope-grid">
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item">
					...
					$i=0;
						require("connect.php");
	                    $query1 = "SELECT id_produk, gambar1, nama, harga FROM produk WHERE id_kategori=3";
