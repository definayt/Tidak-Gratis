          ...
          <div class="x_panel">
              ...
              <div class="x_content">
                ...
                //Asign a query
                  ...
                  echo '<table>';
                    echo '<tr><td>ID Kategori  </td><td>&nbsp;:&nbsp; </td><td>'.$row[0].'</td></tr>';
                    echo '<tr><td>Nama Kategori  </td><td>&nbsp;:&nbsp;</td><td>'.$row[1].'</td></tr>';
                  ...
                  echo '<br />';
                  echo '<br />';
                  echo '<td> <a href="kategori.php" class="btn btn-primary btn-xs"><i class="fa fa-rotate-left"></i> Back</a></td>';
                  $con->close();
