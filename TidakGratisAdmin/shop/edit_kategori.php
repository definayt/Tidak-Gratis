...
<head>
	...
	<title>Edit Kategori | TidakGratis</title>
            ...
            .x_panel {
         	...
         	<div class="x_panel">
                ...
                <?php 
                      ...
                      $id_kategori=$nama=$valid="";

                      if (!isset($_POST["submit"])){ 
                        //ambil data dari database
                        $id_kategori = isset($_GET['id_kategori']) ? $_GET['id_kategori'] : '';

                        $querysub = " SELECT * FROM kategori WHERE id_kategori='$id_kategori' "; 
                        ...
                        $id_kategoribaru = test_input($_POST['id_kategori']); 
                        ...
                        if($valid==true){
                          $id_kategori = isset($_GET['id_kategori']) ? $_GET['id_kategori'] : '';
                          // escape input data 
                          $id_kategoribaru = $con->real_escape_string($id_kategoribaru); 
                          
                          $nama = $con->real_escape_string($nama);  
                         

                          $queryedit = " UPDATE kategori SET id_kategori='$id_kategoribaru', nama='$nama' WHERE id_kategori=".$id_kategori." ";
                          //eksekusi query
                          ...
                          echo "<script type = 'text/javascript'>window.top.location='detail_kategori.php?id_kategori=$id_kategoribaru';</script>";
                          exit();   
                        }
                      }
                    ?>
                <!-- start form for validation -->
                <form id="demo-form" data-parsley-validate method="POST" autocomplete="on" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]).'?id_kategori='.$id_kategori;?>" enctype="multipart/form-data"/>

	                  <label for="id_kategori">Id Kategori :</label>
	                  <input type="number" id="id_kategori" name="id_kategori" data-parsley-trigger="change" required class="form-control" value="<?php echo $id_kategori;?>"/>
	                  <br />


	                  <label for="nama">Nama :</label>
	                  <input type="text" id="username" class="form-control" name="nama" required value="<?php echo $nama;?>"/>
	                  <br />
