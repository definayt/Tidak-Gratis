...
<html lang="en">
  <head>
    ...
    <title>Detail Sub Kategori | TidakGratis</title>
          ...
          <div class="x_content">
            ...
            <table class="table table-striped projects">
                ...
                <tr>
                  ...
                  <th style="width: 12%">Id Sub Kategori</th>
                  <th style="width: 28%">Nama Sub Kategori</th>
            ...
            <?php
              ...
              // }
          		$id_subkategori = isset($_GET['id_subkategori']) ? $_GET['id_subkategori'] : '';
        			...
        			$query = " SELECT sub_kategori.id_kategori, kategori.nama AS nama_kategori, id_subkategori, CONCAT(UCASE(LEFT(sub_kategori.nama, 1)), SUBSTRING(sub_kategori.nama, 2)) AS nama FROM sub_kategori JOIN kategori ON (kategori.id_kategori=sub_kategori.id_kategori) WHERE id_subkategori='$id_subkategori' "; 
              ...
              while($row=$result->fetch_object()){
                ...
                echo '<td>'.$row->id_subkategori.'</td>';
                echo '<td>'.$row->nama.'</td>';
                echo '<td> <a href="sub_kategori.php" class="btn btn-primary btn-xs"><i class="fa fa-rotate-left"></i> Kembali </a></td>';
                echo '</tr>';
              } 
        			echo '<br />'; 
        			$result->free();
