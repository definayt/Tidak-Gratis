...
<html lang="en">
  <head>
    ...
    <title>Tambah Kategori | TidakGratis</title>
          ...
          <div class="x_panel">
              ...
              <div class="x_content">
                <?php 
                      ...
                      $id_kategori=$nama=$last_update=$valid="";
                     //kode untuk validasi field
                      ...
                      if ($valid==true) {
                        ...
                        if (!$result){      
                          ...
                          echo "<script type = 'text/javascript'>window.top.location='kategori.php';</script>";
                          exit();   
                        } 
                        // $result->free();
                       }   
                ...
                <form method="POST" autocomplete="on" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" >
                  ...
                  <input type="number" id="id" class="form-control" name="id_kategori" required value="<?php echo $id_kategori;?>"/>
                  <br />
