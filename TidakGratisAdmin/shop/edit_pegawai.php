...
<head>
	...
	<title>Edit Pegawai | TidakGratis</title>
         	...
         	<div class="x_panel">
                ...
                <?php 
                      ...
                      if (!isset($_POST["submit"])){ 
                        ...
                        $querysub = " SELECT * FROM pegawai WHERE id_pegawai='$id_pegawai' "; 
                        ...
                        if (!$resultsub){   
                          die ("Could not query the database: <br />". $con->error);  
                            ...
                            $id_pegawai = $rowsub->id_pegawai;  
                            $username = $rowsub->username;
                            $nama = $rowsub->nama; 
                            $email = $rowsub->email;
                            $password = $rowsub->password;
                            $level = $rowsub->level;  
                        }   
                      }else{
                        ...
                        if($valid==true){
                          ...
                          $queryedit = " UPDATE pegawai SET id_pegawai='$id_pegawai', username='$username', nama='$nama', email='$email', password='$password', level='$level' WHERE id_pegawai=".$id_pegawai." ";
                          //eksekusi query
                          ...
                          echo "<script type = 'text/javascript'>window.top.location='detail_pegawai.php?id_pegawai=$id_pegawai';</script>";
                          exit();   
                        }
                      }
                    ?>
