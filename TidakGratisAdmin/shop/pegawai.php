...
<html lang="en">
  <head>
    ...
    <title>Pegawai | TidakGratis</title>
        ...
        <div class="right_col" role="main">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <object align="right">
                  <a href="add_pegawai.php" class="btn btn-app">
                    <i class="fa fa-edit"></i> Tambah
                  </a>
                </object>
                <div class="x_title">
                  <h4><br>Tabel Pegawai</h4>
              ...
              <table class="table table-striped projects">
                <thead>
                <tr>
                  <th style="width: 15%; text-align: center;">ID Pegawai</th>
                ...
                <?php
                  ...
                  //Asign a query
                  $query = " SELECT id_pegawai, nama, level FROM pegawai ORDER BY id_pegawai ";
                  // Execute the query
                  ...
                  while ($row = $result ->fetch_object()){
                    ...
                    // echo '<td align="center">'.$row->level.'</td> ';
                      ...
                      echo '<td>
                            <a href="detail_pegawai.php?id_pegawai='.$row->id_pegawai.'" class="btn btn-primary btn-xs"><i class="fa fa-folder"></i> Detail </a>';
                    if ($row->level != 'manager') {
                      echo '<a href="edit_pegawai.php?id_pegawai='.$row->id_pegawai.'" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a>
                            <a href="delete_pegawai.php?id_pegawai='.$row->id_pegawai.'" onclick="return checkDelete()" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete </a>
                          </td>';
                    }
                    else{
                      echo '<a class="btn btn-dark btn-xs"><i class="fa fa-pencil"></i> Edit </a>
                            <a class="btn btn-dark btn-xs"><i class="fa fa-trash-o"></i> Delete </a>
                          </td>';
                    }
